...
| Supported LCD Controllers | AXS15231B | GC9B71 | SH8601 | SPD2010 | ST77916 | ST77922 |
| ------------------------- | --------- | ------ | ------ | ------- | ------- | ------- |
...
This example demonstrates how to drive different model LCDs with `QSPI` interface bus and test them by displaying color bars.
...
- [Mandatory] Edit the macro definitions in the [lcd_qspi.ino](./lcd_qspi.ino) file
...
The following are the logs output when using the `ST77922` LCD. The logs content may vary with different LCDs or different configurations, and it is provided for reference only.

```bash
...
Initializing "QSPI" LCD without config
[I][Panel][esp_lcd_st77922.c:0026](esp_lcd_new_panel_st77922): version: 1.0.2
